...
| Release installer | `curl -fsSL https://raw.githubusercontent.com/jmagar/unifi-rmcp/main/scripts/install.sh \| bash` | Host installs without Node. | Installs `runifi` for the current Linux host. |
